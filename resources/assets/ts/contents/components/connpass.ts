...
class ConnpassService {
     ...
     */
    callConnpassApiJson(http:ng.IHttpService, connpassApiParams:ConnpassApiParams) {
...
class ConnpassCtrl {
    ...
    connpassApiParams:ConnpassApiParams;
    ...
    constructor($http: ng.IHttpService, $location:ng.ILocationService) {
        ...
        this.Math = Math;
        this.connpassService = new ConnpassService();
