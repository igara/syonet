            ...
            it('4つあるタブバーを押下して表示が変わることを確認する', function (done) {
                ...
                browser.executeAsyncScript(function() {
                    ...
                    browser.takeScreenshot().then(function(data) {
                        fs.writeFile(
                            'screenshot/syonetwork_dev/ClickedHomeTab.png',
                ...
                browser.executeAsyncScript(function() {
                    ...
                    browser.takeScreenshot().then(function(data) {
                        fs.writeFile(
                            'screenshot/syonetwork_dev/ClickedContentsTab.png',
                            data.replace(/^data:image\/png;base64,/,''), 
                            'base64',
                            function(error) {
                                if(error) throw error;
                ...
                browser.executeAsyncScript(function() {
                    ...
                    browser.takeScreenshot().then(function(data) {
                        fs.writeFile(
                            'screenshot/syonetwork_dev/ClickedDocsTab.png',
                            data.replace(/^data:image\/png;base64,/,''), 
                            'base64',
                            function(error) {
                                if(error) throw error;
                ...
                browser.executeAsyncScript(function() {
                    ...
                    browser.takeScreenshot().then(function(data) {
                        fs.writeFile(
                            'screenshot/syonetwork_dev/ClickedDevTab.png',
                            data.replace(/^data:image\/png;base64,/,''), 
                            'base64',
                            function(error) {
                                if(error) throw error;
